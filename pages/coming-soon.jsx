    ...
    return (
        <>
            ...
            <Link href = "/" style = {{"margin": "0px"}}>
                <div style = {{height: "550px", padding: "calc(100vw/10)", background: "#072136", margin: "25px", "border-radius": "32px", animation: "0.5s cubic-bezier(0.02, 0.38, 0.22, 0.98) 0s 1 slideInTop"}}>
                    <div class = "overlapContainer">
                        ...
                        <div class = "foreground" style = {{background: "linear-gradient(0.25turn, #072136, rgba(7, 33, 54, 0))"}}>
                            ...
                            <p style = {{color: "white"}}>Sorry for the wait....</p>
                        </div>
                    </div>
                </div>
            </Link>
