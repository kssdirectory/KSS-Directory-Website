...
function KSSResourcesMobile({openState, afterOpen, closeModal}) {
    return (
        ...
        >
            ...
            <div style = {{position: "absolute", top:"0px", bottom:"0px", left:"0px", right:"0px", padding: "calc(100vw/10)", background: "var(--b3BG)", margin: "25px", "border-radius": "32px", animation: "0.5s cubic-bezier(0.02, 0.38, 0.22, 0.98) 0s 1 slideInTop"}}>
                ...
                <div class = "overlapContainer">
                    ...
                    <div class = "foreground" style = {{background: "linear-gradient(0.22turn, var(--b3BG) 20%, rgba(67, 65, 181, 0)"}}>
